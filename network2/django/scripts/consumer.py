...
connection = pika.BlockingConnection(pika.ConnectionParameters(host='rabbitmq2', port=5672))
channel = connection.channel()
channel.exchange_declare(exchange='replication', exchange_type='fanout')
result = channel.queue_declare(queue='certificate_django_queue1', exclusive=True)
